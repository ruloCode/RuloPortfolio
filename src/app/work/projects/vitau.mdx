...
summary: "4+ years leading frontend development for a healthcare e-commerce platform serving 50,000+ patients. From performance optimization to checkout architecture—building systems that save lives."
images:
...
Integrated **Tonder** as the payment gateway, handling:
- Credit/debit cards (Visa, Mastercard, Amex)
- OXXO cash payments (critical for Mexico)
- Bank transfers (SPEI)
- Monthly installments (MSI)

Built a payment abstraction layer allowing easy gateway switching without checkout rewrites.
